...
const MockupCode = ({ children, textToCopy }: { children: ReactNode, textToCopy:string | null }) => {
    ...
    <div className="bg-gray-700 text-white w-full h-full rounded-xl overflow-auto">
      <div className="flex flex-col">
        <div className="pt-3 px-3 self-end">
          <button onClick={openModal}><GoScreenFull /></button>
          <ReactModal
            isOpen={modalIsOpen}
...
const MockupCodeComponent = ({ children, center = false, textToCopy }: { children: ReactNode, center?: boolean, textToCopy:string | null }) => {
  if (center) {
    return (
